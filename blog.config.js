...
const BLOG = {
      ...
      NOTION_PAGE_ID:
            process.env.NOTION_PAGE_ID || '44de8fc516bd46eaa3bde2f9d6299a48',
      ...
      AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '无涯',           // 您的昵称 例如 tangly1024
      BIO: process.env.NEXT_PUBLIC_BIO || '',                     // 作者简介
      LINK: process.env.NEXT_PUBLIC_LINK || 'https://301top.top', // 网站地址
      KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '博客', // 网站关键词 英文逗号隔开
    
      // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
      CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '2180056271@qq.com', // 邮箱地址 例如mail@tangly1024.com
      ...
      BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://q1.qlogo.cn/g?b=qq&nk=2180056271&s=100', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
    ...
    // END ************网站字体*****************
      ...
      BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '鲁ICP备2023015339号', // 备案号 闽ICP备XXXXXXX
      ...
      PRISM_THEME_PREFIX_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_PREFIX_PATH || 'https://npm.elemecdn.com/prism-themes/themes/prism-shades-of-purple.css', // 代码块默认主题
      ...
      PRISM_THEME_DARK_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_DARK_PATH || 'https://npm.elemecdn.com/prism-themes/themes/prism-shades-of-purple.css', // 深色模式主题
      ...
      POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'qq,wechat,weibo,email,facebook,twitter', // 分享的服務，按顺序显示,逗号隔开
      ...
      CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || "vIyaE2ZizHRS8vJgMgI6-",
      ...
      WIDGET_PET_LINK:
            ...
            'https://imuncle.github.io/live2d/model/22/model.2016.xmas.2.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
      ...
      // twikoo
      COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo-1-zeta.vercel.app/', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
      ...
      COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || 'ser-Mi', // 你的用户名 e.g tangly1024
      COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || 'ser-Mi', // 管理员用户名、一般是自己 e.g 'tangly1024'
      COMMENT_GITALK_CLIENT_ID:
            process.env.NEXT_PUBLIC_COMMENT_GITALK_CLIENT_ID || 'cf15095ec8cab602272c', // e.g 20位ID ， 在gitalk后台获取
      COMMENT_GITALK_CLIENT_SECRET:
            process.env.NEXT_PUBLIC_COMMENT_GITALK_CLIENT_SECRET || '82da7ea5caeeae8e7e2a3885bd2dbd1b2e29ef9d', // e.g 40位ID， 在gitalk后台获取
      ...
      ANALYTICS_CNZZ_ID: process.env.NEXT_PUBLIC_ANALYTICS_CNZZ_ID || 'G-EZWHC56K4Z', // 只需要填写站长统计的id, [cnzz_id] -> https://s9.cnzz.com/z_stat.php?id=[cnzz_id]&web_id=[cnzz_id]
